...
{
	//WebDriver Interface
	public void getPageTitle(WebDriver driver , String expectedTitle, String message)
	{
	...
	public void getElementText(WebElement element , String expectedText, String message)
	{
	...
	public void visibilityOfElementLocator(WebDriver driver, String text)
	{
		WebDriverWait wait=new WebDriverWait(driver, Duration.ofSeconds(30));
